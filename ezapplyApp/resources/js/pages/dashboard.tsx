...
export default function Dashboard() {
  ...
  // Only this function actually posts to the backend — called from the Step 5 button
  function doSubmit() {
    transform((d) => ({
      ...d,
          ...
          >
            ...
            {!open ? (
              <div className="relative z-10 flex h-full w-full items-center justify-between p-4">
                <div>
                  <h3 className="text-sm font-semibold text-gray-100">Register your Company/Franchise</h3>
                  <p className="text-xs text-gray-300">Click to start the {STEPS.length}-step setup</p>
                </div>
              ...
              <div className="relative z-10 px-4 pb-4 max-h-[70vh] overflow-y-auto" onClick={(e) => e.stopPropagation()}>
                <div className="mb-4 flex items-center justify-between pt-4">
                  <div>
                    <h3 className="text-sm font-semibold text-gray-100">Register your Company/Franchise</h3>
                    <p className="text-xs text-gray-300">Step {step + 1} of {STEPS.length}</p>
                  </div>
                  <button
                    type="button"
                ...
                >
                  ...
                  {step === 4 && (
                    <div className="grid gap-3">
                      ...
                      <div>
                        <label className="block text-xs text-gray-300">Upload Logo or Brand Images (optional)</label>
                        <input
                          type="file"
                          accept="image/*"
                  ...
                  <div className="mt-4 flex items-center justify-between">
                    <button
                      type="button"
                      onClick={back}
                      className="rounded-lg border border-gray-600 px-3 py-2 text-gray-200 disabled:opacity-40"
